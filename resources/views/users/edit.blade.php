 ...
 <div class="bg-white rounded-2xl overflow-hidden shadow-lg max-w-xl w-full bg-c-lighten-gray modal-content">
            ...
            <div class="p-5 overflow-y-auto scroll" style="max-height: calc(100vh - 10rem)">
                <form class="flex flex-col gap-4 text-sm" id="editUser" action="{{ route('users.update', ['user' => $userdetail->id]) }}" method="PUT">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-10 gap-4 items-start">
                        ...
                        <div class="md:col-span-8 flex items-center gap-2">
                            <div class="relative w-full">
                                <select id="role_id" name="role_id" class="w-full p-2 bg-c-lighten-gray border border-gray-3 rounded-xl outline-none pl-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-10 gap-4 items-start">
                        ...
                        <div class="md:col-span-8 flex items-center gap-2">
                            <div class="relative w-full">
                                <select id="group_id" class="w-full p-2 bg-c-lighten-gray border border-gray-3 rounded-xl outline-none pl-4" name="group_id">
